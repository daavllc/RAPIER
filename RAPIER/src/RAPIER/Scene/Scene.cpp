...
namespace RAPIER
{
	static b2BodyType RigidBody2DTypeToBox2DBody(RigidBody2DComponent::BodyType bodyType)
	{
		...
		RP_CORE_ASSERT(false, "Unknown body type!");
	...
	void Scene::DuplicateEntity(Entity entity)
	{
		...
		CopyComponentIfExists<CircleRendererComponent>(newEntity.m_EntityHandle, entity.m_EntityHandle, m_Registry);
		CopyComponentIfExists<SpriteRendererComponent>(newEntity.m_EntityHandle, entity.m_EntityHandle, m_Registry);
	...
	Entity Scene::FindEntityByTag(const std::string& tag)
	{
		...
		RP_CORE_ASSERT(false, "Entity not found by tag!");
		return Entity{};
	}
	...
	Entity Scene::FindEntityByUUID(UUID id)
	{
		...
		RP_CORE_ASSERT(false, "Entity not found by id!");
		return Entity{};
	}
